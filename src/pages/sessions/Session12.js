...
const Session12 = ({ textSize }) => {
  ...
  return (
    ...
    <div>
      ...
      <a href="https://www.youtube.com/watch?v=HQ0pzpf10hU&list=PLOOURn-ifRuStQm6iyXQuQb3ND4R5jltT&index=12" target="_blank">
      ...
      <ul className="list-dsc list-disc text-[#f091a9] dark:text-black mb-8">
        <li className="ml-4 mb-4">
         ...
         <span className="text-secondary dark:text-black gotham-bold">
           ...
           <a href="https://ptolemee.com/rencontres-biomedecine/13-10_8h30_Lopposition-don-dorganes-et-de-tissus_DEPADT-Valerie.pdf" target="_blank">
        ...
        <li className="ml-4 mb-4">
         ...
         <span className="text-secondary dark:text-black gotham-bold">
           ...
           <a href="https://ptolemee.com/rencontres-biomedecine/13-10_8h30_Lopposition-don-dorganes-et-de-tissus_BRONCHARD%20Regis.pdf" target="_blank">
           <button className="gotham-bold border-2 border-[#f091a9] dark:border-black dark:bg-white flex items-center text-secondary gotham-bold dark:text-black text-sm md:text-base py-2 px-4 font-bold mb-4 md:mb-6 hover:bg-[#f091a9] hover:text-white dark:hover:bg-black dark:hover:text-white">
        ...
        <li className="ml-4 mb-4">
         ...
         <span className="text-secondary dark:text-black gotham-bold">
           ...
           <a href="https://ptolemee.com/rencontres-biomedecine/13-10_8h30_Lopposition-don-dorganes-et-de-tissus_BALLESTE-Chloe.pdf" target="_blank">
           <button className="gotham-bold border-2 border-[#f091a9] dark:border-black dark:bg-white flex items-center text-secondary gotham-bold dark:text-black text-sm md:text-base py-2 px-4 font-bold mb-4 md:mb-6 hover:bg-[#f091a9] hover:text-white dark:hover:bg-black dark:hover:text-white">
        ...
        <li className="ml-4 mb-4">
         ...
         <span className="text-secondary dark:text-black gotham-bold">
           ...
           <a href="https://ptolemee.com/rencontres-biomedecine/13-10_8h30_Lopposition-don-dorganes-et-de-tissus_EMILE-Cedric.pdf" target="_blank">
           <button className="gotham-bold border-2 border-[#f091a9] dark:border-black dark:bg-white flex items-center text-secondary gotham-bold dark:text-black text-sm md:text-base py-2 px-4 font-bold mb-4 md:mb-6 hover:bg-[#f091a9] hover:text-white dark:hover:bg-black dark:hover:text-white">
