...
const Session6 = ({ textSize }) => {
  ...
  return (
    ...
    <div>
      ...
      <a href="https://www.youtube.com/watch?v=yi8OEhKRl6Y&list=PLOOURn-ifRuStQm6iyXQuQb3ND4R5jltT&index=9" target="_blank">
      ...
      <ul className="list-dsc list-disc text-[#ef8661] dark:text-black mb-8">
         ...
         <span className="text-secondary dark:text-black gotham-bold">
           ...
           <a href="https://ptolemee.com/rencontres-biomedecine/12-10_16h_Innovation-dans-la-greffe-de-tissus_THURET-Gilles.pdf" target="_blank">
         ...
         <span className="text-secondary dark:text-black gotham-bold">
           ...
           <a href="https://ptolemee.com/rencontres-biomedecine/12-10_16h_Innovation-dans-la-greffe-de-tissus_BORDERIE-Vincent.pdf" target="_blank">
           <button className="gotham-bold border-2 border-[#ef8661] dark:border-black dark:bg-white flex items-center text-secondary gotham-bold dark:text-black text-sm md:text-base py-2 px-4 font-bold mb-4 md:mb-6 hover:bg-[#ef8661] hover:text-white dark:hover:bg-black dark:hover:text-white">
         ...
         <span className="text-secondary dark:text-black gotham-bold">
           ...
           <a href="https://ptolemee.com/rencontres-biomedecine/12-10_16h_Innovation-dans-la-greffe-de-tissus_GABISON-Eric.pdf" target="_blank">
           <button className="gotham-bold border-2 border-[#ef8661] dark:border-black dark:bg-white flex items-center text-secondary gotham-bold dark:text-black text-sm md:text-base py-2 px-4 font-bold mb-4 md:mb-6 hover:bg-[#ef8661] hover:text-white dark:hover:bg-black dark:hover:text-white">
