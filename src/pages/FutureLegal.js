  ...
  return (
    <div className="px-2 md:container py-8 space-y-8">
      ...
      <div className="">
        ...
        <br />Réaliser le suivi des participations aux rencontres ;
        <br />• Être en conformité avec les obligations légales et réglementaires applicables à l’Agence de la biomédecine
        <br />• Nous ne traitons pas les données d'une manière incompatible avec les objectifs décrits ci-dessus.
        </p>
      </div>
      ...
      <div className="">
        ...
        <br />• par courriel à l’adresse : <a
              href="mailto: dpo@biomedecine.fr " className={`text-primary dark:text-black mb-4`}>dpo@biomedecine.fr</a>
        <br />• par courrier postal, à l’adresse suivante :
        <br />Délégué à la protection des données
        <br />Direction juridique de l’Agence de la biomédecine 
        <br />1 avenue du Stade de France
        <br />93212 SAINT DENIS LA PLAINE Cedex
      ...
      <div className="">
        ...
        <br />• Les données à caractère personnel recueillies pour le suivi des participations sont conservées 1 mois après la fin de la disponibilité de l’événement ;
      ...
      <div className="">
        ...
        en tenant compte de l'état de l'art de la technologie et du coût de mise en œuvre.
        </p>
      </div>
      ...
      <div className="">
        ...
        <br />• Aux services et personnels de l’Agence de la biomédecine ; 
        <br />• Aux fournisseurs et prestataires de services de l’Agence de la biomédecine, notamment ceux en charge des inscriptions des participants aux rencontres de la biomédecine à des fins strictement nécessaires à l’exercice de leur mission ;
        <br />• Aux autorités compétentes telles que les autorités de santé dans certains cas définis par la législation.
        </p>
      </div>
